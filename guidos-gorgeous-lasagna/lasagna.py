...
def preparation_time_in_minutes(layers):
    ...
    This function takes only one argument - an integer - representing the quantity of layers
    needed to cook the recipe and calculates the time that will be spent preparing the lasagna.
    """
    PREPARATION_TIME = 2

    total_preparation_time = layers * PREPARATION_TIME
